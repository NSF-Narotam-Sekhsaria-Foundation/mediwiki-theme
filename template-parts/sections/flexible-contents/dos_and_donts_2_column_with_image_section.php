        ...
        <div class="container padding-left-0 padding-right-0">
            <section>
                ...
                <div class="col-md-6 padding-left-0 padding-right-0">
                    <div class="two-section-image-container">
                            <img src="<?php the_sub_field('dos_image') ?>" class="two-section-image">
                    </div>
                    <ul class="can-donate-with-image">
                        <?php
                        if (have_rows('dos_icon_list')) {
                            while (have_rows('dos_icon_list')) {
                                the_row();
                                ?>
                                <li><img src="<?php echo get_template_directory_uri() . '/images/can-donate.png'; ?>"
                                         class="dos-dont-icon"><?php the_sub_field('icon_list_dos_and_donts_2_column_section'); ?>
                                </li>
                                <?php
                            }
                        }
                ...
                <div class="col-md-6 padding-left-0 padding-right-0">
                    <div class="two-section-image-container">
                            <img src="<?php the_sub_field('dont_image') ?>" class="two-section-image">
                    </div>
                    <ul class="cannot-donate-with-image">
                        <?php
                        if (have_rows('dont_icon_list')) {
                            while (have_rows('dont_icon_list')) {
                                the_row();
                                ?>
                                <li><img src="<?php echo get_template_directory_uri() . '/images/cannot-donate.png'; ?>"
                                         class="dos-dont-icon"><?php the_sub_field('icon_list_dont_and_donts_2_column_section'); ?>
                                </li>
                                <?php
                            }
                        }
